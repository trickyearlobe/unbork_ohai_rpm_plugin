# Get the path to the OHAI gem
path_to_ohai = Gem::Specification.find_by_name("ohai").gem_dir
path_to_rpm_plugin = ::File.join(path_to_ohai,"lib","ohai","plugins","rpm.rb")

replacement_rpm_plugin_content = <<~'RPMPLUGIN'
